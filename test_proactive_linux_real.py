...
if __name__ == "__main__":
    ...
    # Use the same in-memory SQLite connection only for this smoke test by
    # disabling retrieval when no persistent memory is required.
    ...
    # The source emits one real Linux snapshot. The goal/task make the event
    # relevant enough to exercise attention and initiative deterministically.
